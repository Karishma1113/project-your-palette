            ...
            <main className="homepage">
                ...
                <section>
                    <div className="card rounded-4 home-main-selection">
                        <a href="quiz.html">
                            <img src="img/pexels-george-milton-6954213.jpg" className="card-img-top" alt="Person swatching different colors on arm"/>
                    ...
                    <div className="row">
                        <div className="col-sm-6">
                            <div className="card rounded-4 home-selection left-card">
                                <a href="create.html">
                                    <img src="img/zhang-xinxin-cWY499Ma1SQ-unsplash.jpg" className="card-img-top" alt="A palette with paint on it"/>
                        ...
                        <div className="col-sm-6">
                            <div className="card rounded-4 home-selection right-card">
                                <a href="explore.html">
                                    <img src="img/pexels-cottonbro-6583367.jpg" className="card-img-top" alt="Color Palettes Strips"/>
